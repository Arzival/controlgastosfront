    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-darker via-blue-dark to-dark-primary">
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 pt-20 sm:pt-24 lg:pt-32 pb-16 sm:pb-20">
        <div className="max-w-4xl text-left">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-400 mb-8 sm:mb-12 max-w-2xl leading-relaxed">
            {t.hero.description}
          </p>
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-start items-start">
            <Link to="/login" className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white font-semibold rounded-lg shadow-lg transform transition-all duration-200 hover:scale-105 active:scale-95 text-center">
              {t.hero.cta}
            </Link>
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-left mb-12 sm:mb-16 text-gray-100">
          {t.features.title}
        </h2>
      ...
      {/* CTA Section */}
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        <div className="max-w-3xl text-left bg-blue-deep/30 backdrop-blur-sm border border-dark-accent rounded-2xl p-8 sm:p-12">
          ...
          <Link to="/login" className="inline-block px-8 py-4 bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white font-semibold rounded-lg shadow-lg transform transition-all duration-200 hover:scale-105 active:scale-95">
            {t.hero.cta}
          </Link>
        </div>
      </section>
